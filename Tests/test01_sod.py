...
line plotting methods (lines 49-53) in order to show the flexibility of PyPLUTO
in terms of plot cusotmization. A legend is placed (legpos 0 means that the
location is chosen automatically) in order to differenciate the lines. The image
is then saved and shown on screen.
