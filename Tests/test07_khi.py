...
lines = D.find_fieldlines(D.Bx1, D.Bx2, x1 = D.x1, x2 = D.x2,
...
analysis = D.read_file(wdir+'/kh.dat')
...
I.plot(analysis['time'], analysis['vy2'], ax = 2, c = 'k', yscale = 'log',
       xtickslabels = None)
I.plot(analysis['time'], analysis['maxvy'], ax = 3, c = 'k', yscale = 'log',
       xtitle = r'$t$')
