...
def test_format_noexists():
    with pytest.raises(FileNotFoundError):
        D = pp.Load(path = "multiple_files", text = False, datatype = "dbl.h5")
