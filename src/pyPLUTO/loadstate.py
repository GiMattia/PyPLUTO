...
class LoadState(BaseLoadState):
    ...
    lapse: np.ndarray = field(init=False, repr=False)
    shift1: np.ndarray = field(init=False, repr=False)
    shift2: np.ndarray = field(init=False, repr=False)
    shift3: np.ndarray = field(init=False, repr=False)
    gcov11: np.ndarray = field(init=False, repr=False)
    gcov22: np.ndarray = field(init=False, repr=False)
    gcov33: np.ndarray = field(init=False, repr=False)
    gcov12: np.ndarray = field(init=False, repr=False)
    gcov13: np.ndarray = field(init=False, repr=False)
    gcov23: np.ndarray = field(init=False, repr=False)
